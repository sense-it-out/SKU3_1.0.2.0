...
*   version :Parli v1.0.0.0
*   Changes: 25 plots, 6 euro, 13 plots can be scheduled
*   Designed for Global parli Requirement
*
*
*/
...
#define _kRUBLE_ID                                          "CB0155"       /**< store the Ruble ID */
...
#define _kCHECK_REGISTRATION                                  4    //8
...
#define _kEEPROM_LOC_LIRA_SENSOR_DATA(L)                   (L)*40 + 8
#define _kEEPROM_LOC_EURO_VALVE_DATA(L)                    (L)*20 + 970
#define _kEEPROM_LOC_FIRMWARE_VERSION                         1222                /**< 6 BYTES */
#define _kEEPROM_LOC_HARDWARE_VESRION                         1231                /**< 6 BYTES */
#define _kEEPROM_LOC_OPERATION_MODE                           1240
#define _kEEPROM_LOC_RUBLE_SIM_NUM                            1242
#define _kEEPROM_LOC_USER_SIM_NUM                             1255
#define _kEEPROM_LOC_READ_REGISTRATION                        1268
#define _kEEPROM_LOC_COEFF_1                                  1269
#define _kEEPROM_LOC_COEFF_2                                  1277
#define _kEEPROM_LOC_COEFF_3                                  1286
#define _kEEPROM_LOC_PUMP_NOMINAL_CURRENT                     1295
#define _kEEPROM_SMS_ALERT_START                              1304
#define _kEEPROM_KILL_SWITCH                                  1305
#define _kEEPROM_SCHEDULE_DATA                                1306

#define _kEEPROM_CHOOSE_OPERATION                             2540

#define _kEEPROM_EXTRA_PLOT_DATA(L)                       (L-1)*30 + 2545

#define _kKILL_SWITCH_THROUGH_APP                              3220
#define _kTIMER_IRRIGATING_PLOT                                3222
#define _kPUMP_REMAINING_TIME                                  3224
#define _kCT_BY_PASS                                           3233
#define _kEEPROM_LOC_WIRELESS_PUMP_COMMAND                     3240
#define _kEEPROM_LOC_WIRELESS_PUMP_STATUS                      3245
#define _kWIRELESS_PUMP_DATA_SAVE(L)                           (L)*20 + 3246
#define _kHANDLE_WIRELESS_STATUS_LIST                          3720   /* 11 BYTES */
#define _kPUMP_SELECTED_FOR_IRRIGATION                         3755
#define _kFLUSH_RUN_BACK_UP                                    3757
#define  _kRUNNING_FLUSH_NUMBER                                3767
...
#define _kCURRENT_FOR_ONE_VALVE                                200
...
typedef struct Ruble_Parameters
{
	...
	//unsigned char Irrig_Priority[_kMAX_LIRA_SENSOR_NODE];     /**< no. of dry plots */
...
extern volatile unsigned char _gStart_Monitoring_Three_Phase;
extern volatile unsigned char _gTimer_For_Three_Phase_Testing;
extern volatile unsigned int Interrupt_Time_Out;
extern volatile unsigned char Reading_Time;
